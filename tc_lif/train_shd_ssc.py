...
import brainstate
import braintools
from data import load_shd_ssc_dataset
from models import get_neuron, FFNetSHD, RecNetSHD
...
def parse_args():
    ...
    parser.add_argument('--lr', '--learning-rate',
                        default=0.001, type=float, metavar='LR', help='initial learning rate', dest='lr')
    ...
    parser.add_argument('--beta1', default=-0.815, type=float, help='')
    parser.add_argument('--beta2', default=0.360, type=float, help='')
...
def main():
    ...
    train_loader, test_loader, input_size = load_shd_ssc_dataset(args)

    # trainer and training
    trainer = Trainer(args, input_size)
